...
The interviewees all wished to remain anonymous. Because of this, the transcriptions, recordings and the files used for analysis are not publicly available. All the interviewees gave consent to transcriptions and recordings for this research.  Instead of sharing the transcriptions and recordings, this thesis contains summaries of the interviews (\cref{app:interviewsummaries}). The interviewees validated these summaries, and gave their consent to publish those instead.
\begin{table}[H]
	\centering
	\resizebox{\textwidth}{!}{%
...
\section{Attributes most probable to be success factors}
