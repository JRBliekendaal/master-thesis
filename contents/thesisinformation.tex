\pagenumbering{gobble}
	\begin{tabular}{p{0.3\textwidth}p{0.7\textwidth}}
		...
		Title: & Accelerate in a world of chaos by using Enterprise Architecture with the concept Antifragility \\
...
\vspace{\baselineskip}
	...
	\begin{tabular}{p{1\textwidth}}
		\textbf{Keywords} \\
		agile, agility, resilient, resiliency, robust, robustness, antifragility, antifragile, enterprise architecture, it architecture, architecture governance, architecture principles, enterprise engineering, public sector, independent software vendor, organisational design\\%
	\end{tabular}
