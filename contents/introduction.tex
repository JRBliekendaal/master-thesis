...
In this thesis, I define the \acrfull{ea} success factors for contribution to become \gls{antifragile}. I use the boundary of the local governmental agencies of the public sector (a \acrlong{sos}) as my lens.
