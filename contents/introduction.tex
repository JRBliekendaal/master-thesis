...
In this thesis, I define the \acrfull{ea} success factors for contribution to become \gls{antifragile}. I use the contextual boundary of the Public Sector as his lens.
...
\begin{remark}
	...
	This section needs some work! The context of public sector is not part of the first part of the relevance... (work in progress)
\end{remark}
